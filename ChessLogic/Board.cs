...
namespace ChessLogic
{
    public class Board
    {
        ...
        private void AddStartPieces()
        {
            ...
            // White pieces in the bottom row
        ...
        public bool InsufficientMaterial()
        {
            ...
            return IsKingVKing(counting) || IsKingBishopKing(counting) || IsKingKnightVKing(counting) || IsKingBishopVKingBishop(counting);
        }
        ...
        private static bool IsKingBishopKing(Counting counting)
        {
        ...
        private bool IsUnmovedKingAndRook(Position kingPos, Position rookPos)
        {
            ...
            // though we not need to check PieceType because if in these position a piece is
            // unmoved, they must be a king and a rook
